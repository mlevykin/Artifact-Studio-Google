...
- **Markdown**: Использует стандартный вертикальный скролл для удобства чтения длинных документов.
- **Диаграммы**: Оборачиваются в `ZoomableContainer` для возможности масштабирования и панорамирования.
